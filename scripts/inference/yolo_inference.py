...
MODEL_FILE = "/teamspace/studios/this_studio/runs/detect_50/train/weights/best.pt"
...
video_info = sv.VideoInfo.from_video_path(video_path="/teamspace/studios/this_studio/clip_001.mp4")
# Create a frame generator and video info object from supervision utilities.
frame_generator = sv.get_video_frames_generator("/teamspace/studios/this_studio/clip_001.mp4")
...
with sv.VideoSink(target_path="output.mp4", video_info=video_info) as sink:
    ...
    for frame in tqdm(frame_generator, total=video_info.total_frames):
        ...
        result = model.predict(frame, imgsz = 560)
